...
2.) Setup the Databaseconnection in php/queryDb.php (line 9) to match your installation

3.) Open up a webbrowser and and point it to the location you have created 
